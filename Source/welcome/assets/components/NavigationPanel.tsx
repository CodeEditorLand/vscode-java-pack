	...
	private groups = [
		{
			...
			actions: [
				...
				{
					name: "Open Java Settings",
					command: "workbench.action.openSettings",
					args: ["java."],
				},
				{ name: "Install Extensions...", command: "java.extGuide" },
				{
					name: "Configure Formatter Settings",
		...
		},
		{
			...
			actions: [
				...
				{
					name: "Spring PetClinic Sample Application",
					command: "java.helper.openUrl",
					args: [
				...
				{
					name: "Install Spring Boot Extension Pack ...",
		...
		},
		{
			...
			actions: [
				{
					name: "Coding and Debugging Tips",
					command: "java.gettingStarted",
				},
				{
					name: "Tutorial: Running and Debugging",
					command: "java.helper.openUrl",
					args: [
				...
				{
					name: "Configure Sources, Dependencies, Output Folder...",
					command: "java.classpathConfiguration",
				},
				{
					name: "Quick Start: Jupyter Notebook for Java",
					command: "java.helper.openUrl",
					args: [
						"https://github.com/microsoft/vscode-java-pack/wiki/Quick-Start:-Jupyter-Notebook-for-Java",
					],
				},
				{
					name: "Enable AWT Development",
					command: "java.toggleAwtDevelopment",
					args: [true],
				},
			],
		},
	...
	render() {
		...
		const tabItems = this.groups.map((group) => {
			const actionItems = group.actions.map((action) => (
				<a
					href={encodeCommandUriWithTelemetry(
						WEBVIEW_ID,
						action.name,
						action.command,
						action.args
			...
			return (
				<Tab
					...
					title={titleNode}
					key={group.name}
					className="navigation-tabcontent"
					tabClassName="navigation-tab">
					<ListGroup>{actionItems}</ListGroup>
				</Tab>
			);
		});
