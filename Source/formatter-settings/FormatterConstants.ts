...
export namespace Example {
	export const INDENTATION_EXAMPLE =
		"package com.example;\n" +
		"\n" +
		"class Example {\n" +
	...
	export const BLANKLINE_EXAMPLE =
		"package com.example;\n" +
		"\n" +
	...
	export const INSERTLINE_EXAMPLE =
	...
	export const BRACED_CODE_TYPE_EXAMPLE =
	...
	export const BRACED_CODE_RECORD_EXAMPLE =
	...
	export const BRACED_CODE_ENUM_EXAMPLE =
	...
	export const ANNOTATION_AND_ANONYMOUS_EXAMPLE =
	...
	export const WHITESPACE_EXAMPLE =
		"package example;\n" +
		"class Example {\n" +
...
const supportedVSCodeSettings: Map<string, JavaFormatterSetting> = new Map<
	string,
	JavaFormatterSetting
>([
	[
...
export function getSupportedVSCodeSettings(): Map<
	string,
	JavaFormatterSetting
> {
...
const supportedProfileSettings: Map<string, JavaFormatterSetting> = new Map<
	string,
	JavaFormatterSetting
>([
	[
...
export function getSupportedProfileSettings(
	version: number,
): Map<string, JavaFormatterSetting> {
	const settings: Map<string, JavaFormatterSetting> = new Map<
		string,
		JavaFormatterSetting
	>();
	...
	supportedProfileSettings.forEach((value, key) => {
		if (
			...
			(!value.deprecatedVersion || value.deprecatedVersion > version)
		) {
