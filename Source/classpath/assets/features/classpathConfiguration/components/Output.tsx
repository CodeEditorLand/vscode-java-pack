...
const Output = (): JSX.Element => {
	const output: string = useSelector(
		(state: any) => state.classpathConfig.output
	);
	...
	useEffect(() => {
		...
		return () =>
			window.removeEventListener("message", onDidSelectOutputPath);
	}, []);
