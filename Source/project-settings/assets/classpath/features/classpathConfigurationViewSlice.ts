	...
	reducers: {
		...
		removeReferencedLibrary: (state, action) => {
			...
			if (
				...
				state.data.libraries[activeProjectIndex].splice(
					removedIndex,
					1,
				);
			}
