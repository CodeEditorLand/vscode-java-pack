...
const Profile = (): JSX.Element => {
	...
	const activeProfiles: string | undefined = useSelector(
		(state: any) =>
	...
	return (
		<div className="setting-section">
			<div className="setting-section-subtitle">
				<h4 className="mb-1 mr-1 mt-3">Active Maven Profiles</h4>
				<span>(comma separated)</span>
			</div>

			<VSCodeTextField
				className="setting-section-text"
				value={activeProfiles ?? ""}
				onInput={handleInput}></VSCodeTextField>
		</div>
	);
};
