...
import {
	...
	loadClasspath,
	updateActiveTab,
} from "../../classpath/features/classpathConfigurationViewSlice";
...
} from "../../compiler/features/compilerConfigurationViewSlice";
...
} from "../../maven/features/mavenConfigurationViewSlice";
		...
		return (
			<div className="root">
				...
				<div className="app-container">
					<SideBar />
					<div className="app-frame">{getSectionContent()}</div>
				</div>
				<VSCodeDivider />
				<Footer />
			</div>
