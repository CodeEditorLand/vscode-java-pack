...
export namespace ClasspathRequest {
	...
	export function onWillUpdateClassPaths(
		rootPath: string,
	...
	export function onClickGotoProjectConfiguration(
		rootUri: string,
		projectType: ProjectType,
	) {
		vscode.postMessage({
...
export namespace MavenRequest {
	...
	export function onWillUpdateSelectProfiles(
		uri: string,
...
export namespace CompilerRequest {
	...
	export function onWillUpdateCompilerSettings(
		uri: string,
		useRelease: boolean,
