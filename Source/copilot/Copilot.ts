...
export default class Copilot {
	...
	public static readonly DEFAULT_MODEL_OPTIONS: LanguageModelChatRequestOptions =
		{ modelOptions: {} };
	public static readonly NOT_CANCELLABEL: CancellationToken = {
		isCancellationRequested: false,
		onCancellationRequested: () => Disposable.from(),
	};
	...
	public async send(
		...
		return fixedInstrumentSimpleOperation(
			"java.copilot.sendRequest",
			this.doSend.bind(this),
		)(userMessage, modelOptions, cancellationToken);
	}
}
