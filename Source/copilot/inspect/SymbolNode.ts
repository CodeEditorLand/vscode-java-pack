...
export class SymbolNode {
	...
	public constructor(
		...
		this.snapshotId = SymbolNode.calculateSymbolSnapshotId(
			document,
			symbol,
		);
	}
	...
	public get children(): SymbolNode[] {
		return this.symbol.children.map(
			(symbol) => new SymbolNode(this.document, symbol, this),
		);
	}
	 ...
	 */
	private static calculateSymbolSnapshotId(
