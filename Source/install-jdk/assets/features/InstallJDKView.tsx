	...
	return (
		<div className="install-jdk-view">
			...
			<div className="footer">
				<p>
					After you finish JDK installation, please reload Visual
					Studio Code to make it effective.
				</p>
				<div>
					<Button appearance="secondary" onClick={onWillReloadWindow}>
						Reload Window
					</Button>
					<Link
						className="troubleshoot-link"
						href={encodeExternalLinkWithTelemetry(
							WEBVIEW_ID,
							"Having trouble?",
							helpLink
						)}>
